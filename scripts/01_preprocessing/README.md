...
If a sublibrary was sequenced across more than one lane, first concatenate the FASTQ files for that same sublibrary. Concatenate lanes belonging to the same sublibrary only. Do **not** merge different sublibraries together.
...
###### Example: splitting by multiple groups
